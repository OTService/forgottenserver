...
namespace LuaVocation {
static void registerFunctions(LuaScriptInterface* interface)
{
	interface->registerClass("Vocation", "", luaVocationCreate);
	interface->registerMetaMethod("Vocation", "__eq", interface->luaUserdataCompare);

	interface->registerMethod("Vocation", "getId", luaVocationGetId);
	interface->registerMethod("Vocation", "getClientId", luaVocationGetClientId);
	interface->registerMethod("Vocation", "getName", luaVocationGetName);
	interface->registerMethod("Vocation", "getDescription", luaVocationGetDescription);

	interface->registerMethod("Vocation", "getRequiredSkillTries", luaVocationGetRequiredSkillTries);
	interface->registerMethod("Vocation", "getRequiredManaSpent", luaVocationGetRequiredManaSpent);

	interface->registerMethod("Vocation", "getCapacityGain", luaVocationGetCapacityGain);

	interface->registerMethod("Vocation", "getHealthGain", luaVocationGetHealthGain);
	interface->registerMethod("Vocation", "getHealthGainTicks", luaVocationGetHealthGainTicks);
	interface->registerMethod("Vocation", "getHealthGainAmount", luaVocationGetHealthGainAmount);

	interface->registerMethod("Vocation", "getManaGain", luaVocationGetManaGain);
	interface->registerMethod("Vocation", "getManaGainTicks", luaVocationGetManaGainTicks);
	interface->registerMethod("Vocation", "getManaGainAmount", luaVocationGetManaGainAmount);

	interface->registerMethod("Vocation", "getMaxSoul", luaVocationGetMaxSoul);
	interface->registerMethod("Vocation", "getSoulGainTicks", luaVocationGetSoulGainTicks);

	interface->registerMethod("Vocation", "getAttackSpeed", luaVocationGetAttackSpeed);
	interface->registerMethod("Vocation", "getBaseSpeed", luaVocationGetBaseSpeed);

	interface->registerMethod("Vocation", "getDemotion", luaVocationGetDemotion);
	interface->registerMethod("Vocation", "getPromotion", luaVocationGetPromotion);

	interface->registerMethod("Vocation", "allowsPvp", luaVocationAllowsPvp);
}
} // namespace LuaVocation
